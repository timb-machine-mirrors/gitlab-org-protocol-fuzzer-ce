...
C:\peachfarm\mongodb\bin\mongod.exe --config C:\peachfarm\mongodb\mongod.cfg --install
net start MongoDB
C:\peachfarm\mongodb\bin\mongo.exe admin --eval "db.addUser('beta','Beta53cr3t')"
