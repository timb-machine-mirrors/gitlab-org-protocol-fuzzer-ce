...
+
image::{images}/Install_Site_Home.PNG["Download Home Page", scale="30"]
 
   a. Click Browse. The Upload dialog display, allowing you to select the Peach license file. 
+
image::{images}/Install_LicenseUpload.PNG["Upload Dialog", scale="30"]
...
+
image::{images}/Install_Image_Choices.PNG["Peach Image Choices", scale="40"]
...
+
image::{images}/Install_EULA_Acceptance.PNG["Peach EULA Acceptance", scale="40"]
