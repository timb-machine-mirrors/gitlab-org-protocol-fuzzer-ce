...
Sample Ninja takes sample files used in fuzzing, runs them through the Peach data crackers, and places them into a database. During fuzzing, a sample ninja mutator will mix-and-match file sections to create a new file.
