...
image::{images}/NetDevice_Router.png["Network Device to Fuzz", scale="40"]
...
image::{images}/Network_Device.png["Configuration diagram Fuzzing a Network Device", scale="50"]
...
image::{images}/Local_Agent.png["Local agent for Network Device", scale="50"]
...
image::{images}/IpPower9258_Boot.png["IpPower 9258 Monitor", scale="50"]

The *Port* parameter identifies the receptacle of the IpPower9258 device. Numbers range
from 1 to 4. Receptacle 1 is the leftmost recepticle.

image::{images}/IpPower_RearPanel2.png["IpPower 9258 Recepticles", scale="50"]
...
image::{images}/IpPower9258_Reboot.png["IpPower 9258 Monitor", scale="50"]
...
image::{images}/Serial_WaitForBootOnStartAndFault2.png["Serial Monitor - Part I", scale="50"]
...
image::{images}/Serial_WaitForBootAfterFault2.png["Serial Monitor - Part II", scale="50"]
...
image::{images}/TcpPort_VerifyDeviceAlive.png["TcpPort Verify the Device is Alive", scale="50"]
...
image::{images}/NetworkCapture_Interesting.png["Capture Network Packs", scale="50"]
