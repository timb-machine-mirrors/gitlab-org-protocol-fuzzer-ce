...
// The primary audience is a daily user, not a developer and not knowledgable about XML.
...
:leveloffset: 0
<<<
include::06_WebUI/00_Section.adoc[]
...
:leveloffset: 0
<<<
include::10_Appendixes/00_Section.adoc[]
