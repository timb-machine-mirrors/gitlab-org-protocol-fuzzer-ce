...
This is new behavior. When Peach detects a fault, it attempts to reproduce the fault. The idea is to automate the search to determine whether a fault consistently reproduces. The following steps describe the major elements of the search:
