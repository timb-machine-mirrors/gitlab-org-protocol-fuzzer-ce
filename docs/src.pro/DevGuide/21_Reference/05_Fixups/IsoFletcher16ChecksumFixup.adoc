...
The _IsoFletcher16Checksum_ produces a checksum defined in RFC 1008 section 7.
OSPV version 2 is one notable protocol which uses this checksum algorithm,
