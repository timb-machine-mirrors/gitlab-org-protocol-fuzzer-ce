...
Each part of a multipart request can include it's own set of HTTP headers and a body composed of xref:web_FormData[FormData] elements or a single xref:web_Body[Body] element.
