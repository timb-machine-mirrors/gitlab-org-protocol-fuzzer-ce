...
:leveloffset: 3
include::start.adoc[start]
include::stop.adoc[stop]
include::open.adoc[open]
include::close.adoc[close]
include::accept.adoc[accept]
include::input.adoc[input]
include::output.adoc[output]
include::call.adoc[call]
include::getProperty.adoc[getProperty]
include::setProperty.adoc[setProperty]
include::slurp.adoc[slurp]
include::changeState.adoc[changeState]
