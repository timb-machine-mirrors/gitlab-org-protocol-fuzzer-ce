...
*forceMultiByteIdentifier*:: If "true", use multiple identifier octets to contain the identifier of the Asn.1 element. +
...
The default is "false".
*longLength*:: If "true", always use the long encoding form (that is, multiple length octects) to express the length of the Asn.1 element. +
