...
+
image::{images}/Monitor_CleanFolder_PreFuzz.png["Folder Before Fuzzing", scalewidth="75%"]
...
+
image::{images}/Monitor_CleanFolder_Cleaned.png["Folder With Monitor", scalewidth="75%"]
...
+
image::{images}/Monitor_CleanFolder_NotCleaned.png["Folder Without Monitor", scalewidth="75%"]
