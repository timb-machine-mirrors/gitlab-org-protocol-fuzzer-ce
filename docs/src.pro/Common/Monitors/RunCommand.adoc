...
StartOnCall::
Launch the command when the monitor receives the specified message from the state machine.
...
Timeout::
Maximum time period, in seconds, for the process to run.
...
====================
This parameter example runs the `copy_files.py` python script when the `DoCopyFiles` call is received from the state model.
...
----
include::RunCommand_Example_FaultDetection.log[]
----
=========================================
...
----
include::RunCommand_Example_DataCollection.log[]
----
=========================================
...
----
include::RunCommand_Example_Automation.log[]
----
=========================================
