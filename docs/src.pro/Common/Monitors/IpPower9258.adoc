...
IP Power 9258 is the only networked power switch that Peach supports.
If you wish to fuzz another networked power controller or switch,
you will need to write your own monitor.

You can purchase "IP Power 9258" Remote Network (or Network AC) Power Controllers from a variety of online retailers.

===============================

TIP: For controlling power to a device by wiring through a relay,
Peach provides a monitor for the xref:Monitors_CanaKitRelay[CanaKit 4-Port USB Relay Controller].
