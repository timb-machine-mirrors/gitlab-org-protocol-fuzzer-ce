...
+
CAUTION: Excluding fields from testing should be used judiciously as it can lead to undiscovered faults. It's our recommendation that all fields get tested.
