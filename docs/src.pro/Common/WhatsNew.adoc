...
Both the HTTP and WebApi publishers have been updated this release cycle:
...
ifndef::peachug[]
See the xref:Publishers_Http[Http Publisher] and xref:Publishers_WebApi[WebApi Publisher] for more information.
endif::peachug[]
...
link:https://www.getpostman.com[Postman] is a popular app used during development and testing of WebApi style web services.
...
of the major changes that have occurred.
