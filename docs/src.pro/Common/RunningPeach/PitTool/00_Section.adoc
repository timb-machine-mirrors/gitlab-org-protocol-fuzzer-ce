...
Commands:
  ...
  nunit                      Create an assembly that can be used by NUnit.
  test                       Run standard pit tests.
...
xref:PitTool_Nunit[nunit]::
	Create an assembly that can be used by NUnit.

xref:PitTool_Test[test]::
