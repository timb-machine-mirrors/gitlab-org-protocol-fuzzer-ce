...
NOTE: Even though a data element is excluded, it may appear to still be fuzzed. This is due to other elements being fuzzed. However, the excluded element does not have any specific mutations performed directly to it.
...
None. If no attributes are specified, Peach excludes all data elements from fuzzing. 
