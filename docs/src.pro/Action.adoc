...
xref:name[name]:: Name of the action [optional]
xref:Action_Types[type]:: Action type [required], see list of action types
...
xref:xpath[valueXpath]:: Path to the source element defined using XPath notation [type=slurp]
xref:xpath[setXpath]:: Path to the destination element defined using XPath notation [type=slurp]
xref:ref[ref]:: Reference of state to change to [type=changeState]
property:: Name of property to get/set in the publisher [type=setProperty or type=getProperty]
...
include::Actions/start.txt[start]
include::Actions/stop.txt[stop]
include::Actions/open.txt[open]
include::Actions/close.txt[close]
include::Actions/accept.txt[accept]
include::Actions/input.txt[input]
include::Actions/output.txt[output]
include::Actions/call.txt[call]
include::Actions/getProperty.txt[getProperty]
include::Actions/setProperty.txt[setProperty]
include::Actions/slurp.txt[slurp]
include::Actions/changeState.txt[changeState]
