...
A string containing ASCII or Unicode character. Strings can be null terminated, padded, with or without a fixed length. All strings are encoded prior to output with the default encoding 7-bit ASCII (aka latin-1). A number of different Unicode encodings are also supported (see the _type_ attribute). Strings are also used to hold numbers that will be in a string format. When strings contain a number, the numerical mutators will also be used to mutate the string.
...
xref:Mutators_NumericalEdgeCaseMutator[NumericalEdgeCaseMutator]:: 
	Produces values in a range of N - 50 through N + 50 for all numerical edge cases
xref:Mutators_NumericalVarianceMutator[NumericalVarianceMutator]:: TODO
xref:Mutators_StringCaseMutator[StringCaseMutator]:: TODO
xref:Mutators_StringMutator[StringMutator]:: TODO
xref:Mutators_UnicodeBadUtf8Mutator[UnicodeBadUtf8Mutator]:: TODO
xref:Mutators_UnicodeBomMutator[UnicodeBomMutator]:: TODO
xref:Mutators_UnicodeStringsMutator[UnicodeStringsMutator]:: TODO
xref:Mutators_UnicodeUtf8ThreeCharMutator[UnicodeUtf8ThreeCharMutator]:: TODO
xref:Mutators_ValidValuesMutator[ValidValuesMutator]:: TODO
xref:Mutators_WordListMutator[WordListMutator]:: TODO
xref:Mutators_XmlW3CMutator[XmlW3CMutator]:: TODO
