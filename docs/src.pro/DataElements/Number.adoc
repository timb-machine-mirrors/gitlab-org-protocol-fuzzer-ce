...
xref:minOccurs[minOccurs]::
	The minimum number of times this number must occur. Valid values are positive integers, defaults to 1.
xref:maxOccurs[maxOccurs]::
	The maximum number of times this number can occur. Valid values are positive integers. This attribute has no default value.
xref:occurs[occurs]::
	The actual number of times this number occurs. Valid values are positive integers, defaults to 1.
