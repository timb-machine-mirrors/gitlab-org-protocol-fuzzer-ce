...
NOTE: The XmlElement and the XmlAttribute elements do not support cracking of data. If you need to crack XML content into XmlElement and XmlAttribute elements, use an xref:Analyzers_Xml[XmlAnalyzer] attached to a String element.
