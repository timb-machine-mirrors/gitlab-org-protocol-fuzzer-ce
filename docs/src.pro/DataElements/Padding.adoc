...
When padding the data, value in the pad characters is always 0. This is not customizable.
...
alignedTo:: Name of element to align the padding on, defaults to parent element.
