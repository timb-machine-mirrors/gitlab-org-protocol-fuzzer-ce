...
The DataModel element is a child of the Peach root element.  DataModels defines the structure of data blocks by specifying additional child elements such as xref:Number[Number], xref:Blob[Blob], or xref:String[String].
