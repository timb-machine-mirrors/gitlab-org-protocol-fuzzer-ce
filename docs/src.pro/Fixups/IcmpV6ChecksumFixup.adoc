...
The _IcmpV6ChecksumFixup_ _ will produce a checksum using the ICMPV6 algorithm used commonly in ICMP and IPv6. It is defined and documented in RFC 1071 and RFC 2460 and can be found in the Custom Peach implementation.
 ...
 * _src_ -- Source IPv6 address of the local machine
 * _dst_ -- Destination IPv6 address of the remote machine
