...
The onStart attribute is a python statement that is evaluated prior to preforming the actions in a xref:State[State].
...
See also the xref:State_onComplete[onComplete] attribute.
