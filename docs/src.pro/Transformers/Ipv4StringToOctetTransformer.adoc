...
_Ipv4StringToOctet_ will produce the bytes from the string representation of an Internet Protocol version 4 address.
...
xref:Action_input[input]:: On input, Ipv4StringToOctet will convert bytes into an IP address string representation.
xref:Action_output[output]:: On output, Ipv4StringToOctet will convert an IP address string representation into bytes.
