...
xref:Action_input[input]:: On input this transformer will convert a hex string representation of a number into ascii for the incoming data.
xref:Action_output[output]:: On output this transformer will convert an ascii number into a hex string for the outgoing data.
