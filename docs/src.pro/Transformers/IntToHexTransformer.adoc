...
xref:Action_input[input]:: On input, IntToHex will convert a hex string representation of a number into ASCII for the incoming data.
xref:Action_output[output]:: On output, IntToHex will convert an ASCII number into a hex string for the outgoing data.
