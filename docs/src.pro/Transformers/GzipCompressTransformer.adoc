...
xref:Action_input[input]:: On input, GzipCompress will decompress incoming data.
xref:Action_output[output]:: On output, GzipCompress will compress all outgoing data.
