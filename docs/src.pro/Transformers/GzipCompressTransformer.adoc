...
The _GzipCompressTransformer_ performs a Gzip compression on the value in the parent xref:DataModel[DataModel].
...
xref:Action_input[input]:: On input this transformer will decompress incoming data.
xref:Action_output[output]:: On output this transformer will compress all outgoing data.
  ...
  xsi:schemaLocation="http://peachfuzzer.com/2012/Peach ../peach.xsd">
	...
	<StateModel name="TheState" initialState="initial">
		<State name="initial">
			...
			<!-- Read and comcompress file and slurp output to console -->
