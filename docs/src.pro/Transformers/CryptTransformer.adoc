...
The _CryptTransformer_ will perform a Unix crypt operation on the provided value in the parent xref:DataModel[DataModel].
...
==========================
This example uses the Crypt transformer on an inline value and writes the transformed value to the console. 
