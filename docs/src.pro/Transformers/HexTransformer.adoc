...
// Updated:
// - 03/26/2014 Lynn
//Corrected the transformer name and did general edits.
...
xref:Action_input[input]:: On input, HexTransformer will convert a hex string into ASCII for the incoming data.
xref:Action_output[output]:: On output, HexTransformer will convert ASCII into a hex string for the outgoing data.
