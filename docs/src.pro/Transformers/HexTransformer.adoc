...
xref:Action_input[input]:: On input this transformer will a hex string into ascii for the incoming data.
xref:Action_output[output]:: On output this transformer will convert ascii into a hex string for the outgoing data.
