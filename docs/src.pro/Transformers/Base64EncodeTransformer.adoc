...
xref:Action_input[input]:: On input this transformer will Base64 decode the incoming data.
xref:Action_output[output]:: On output this transformer will Base64 encode the outgoing data.
