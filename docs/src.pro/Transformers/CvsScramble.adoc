...
The _CvsScramble_ transformer performs a pserver password scramble on the given value. The xref:Transformer[Transformer] can bidirectionally encode and decode data.
