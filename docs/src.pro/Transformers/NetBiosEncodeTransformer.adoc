...
xref:Action_input[input]:: On input this transformer will decode the incoming data.
xref:Action_output[output]:: On output this transformer will encode the outgoing data.
