...
// Updated:
// - 03/26/2014 Lynn
//Corrected the transformer name and change inappropriate decode occurrences to encode

=== Transformer type: Encoder/Decoder

_NetBiosEncode_ performs a NetBios encode of the value in the parent xref:DataModel[DataModel].
...
xref:Action_input[input]:: On input, NetBiosEncode will encode the incoming data.
xref:Action_output[output]:: On output, NetBiosEncode will encode the outgoing data.
