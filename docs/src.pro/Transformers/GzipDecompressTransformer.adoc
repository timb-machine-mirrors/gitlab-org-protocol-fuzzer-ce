...
xref:Action_input[input]:: On input this transformer will compress incoming data.
xref:Action_output[output]:: On output this transformer will decompress all outgoing data.
=== Examples
