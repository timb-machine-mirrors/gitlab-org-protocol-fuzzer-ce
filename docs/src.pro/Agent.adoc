...
REST JSON (http)::
	The agent protocol uses REST style calls over HTTP. This channel is best suited for custom Peach agents. For more information, see the _Peach Professional Developer Guide_.
