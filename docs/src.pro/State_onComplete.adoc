...
The _onComplete_ attribute is a scripting statement that is evaluated after preforming the actions in a xref:State[State].
...
See also the _xref:State_onStart[onStart]_ attribute.
