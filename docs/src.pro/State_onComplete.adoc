...
The _onComplete_ attribute is a python scripting statement that is evaluated prior to preforming the actions in a xref:State[State] model. 
This statement can be used to increment a counter or preform other functions defined in separate files included with the xref:Import[Import] element.
...
==========================
This example will print a message when the _onComplete_ statement is run.
