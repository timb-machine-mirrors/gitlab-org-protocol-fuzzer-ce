...
You can configure a debugger monitor to launch and monitor this process. See xref:Monitors_WindowsDebugger monitor for more information about configuring a debugger monitor.
