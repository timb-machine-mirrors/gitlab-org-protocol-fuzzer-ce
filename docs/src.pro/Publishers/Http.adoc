...
Method:: HTTP Method type (like GET and POST) *required*
Url:: URL of target *required*
...
CookiesAcrossIterations:: Track cookies across iterations (optional, defaults to false)
