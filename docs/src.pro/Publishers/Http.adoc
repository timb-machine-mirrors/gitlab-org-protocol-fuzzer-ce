 ...
 * _Method_ -- HTTP Method type (like GET and POST) *required*
 * _Url_ -- URL of target *required*
 ...
 * _CookiesAcrossIterations_ -- Track cookies across iterations (optional, defaults to false)
...
=== Actions
  ...
  * xref:Action_call[call] -- Call a method to fuzz the query string or headers
