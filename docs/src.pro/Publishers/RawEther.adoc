...
Filter::
    Filters received frames using a libpcap-style filter string. For more information
...
xref:Action_output[output]:: Writes data through ouput to the open socket.
