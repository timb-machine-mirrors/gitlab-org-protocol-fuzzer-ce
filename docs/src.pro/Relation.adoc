...
In this model we will use a typical patter where an array of offsets gives us the location of another element. We will use the xref:Placement[Placement] element to move the created _Data_ strings to after our block called _Chunks_.
