...
.Publishers and Associated Actions
...
IMPORTANT: changeState and slurp cannot be called by any publishers
...
of the existing Publishers to understand how they are typically implemented. 
