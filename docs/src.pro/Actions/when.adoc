...
The _when_ attribute is a Python boolean expression that is evaluated before preforming an action.
If the Python expression evaluates to true, the action will be performed, otherwise the action is skipped.
