...
==========================
This is an example of the default implicit behaviour of _open_. Note the absence of any declaration for _open_.
...
The netcat program can be used to simulate a listener. Netcat will run twice, once per connection.
