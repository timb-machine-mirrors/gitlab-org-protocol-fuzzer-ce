...
The _open_ (or _connect_) action will cause the associated publisher to open its resource.
...
Open is an implicit action that occurs by default at the start of each iteration. 
