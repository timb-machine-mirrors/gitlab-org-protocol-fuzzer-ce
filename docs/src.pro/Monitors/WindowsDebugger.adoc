...
ServiceStartTimeout:: When debugging a windows service, this specifies, expressed in seconds,
how long the monitor should wait for the service to start. The default value is 60 seconds.
