...
==================
This example will run CrashableServer.exe and capture all network traffic using the pcap monitor when a fault occurs. This example needs to point to the location of CrashableServer which is normally located in the Peach directory.
