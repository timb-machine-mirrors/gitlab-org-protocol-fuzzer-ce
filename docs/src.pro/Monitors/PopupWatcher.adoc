...
_PopupWatcher_ monitors the test target for a list of pop-up windows. When _PopupWatcher_ detects a pop-up window whose name matches an entry specified by +WindowNames+, this moniotr triggers a fault and closes the pop-up window.
