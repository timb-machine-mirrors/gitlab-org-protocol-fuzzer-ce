...
Since notepad doesn't close automatically you must close notepad after each iteration. Using WaitForExitOnCall is useful when you want the process to block fuzzing until the process closes before continuing.
