...
This monitor requires the http://developer.android.com/tools/help/emulator.html[Android Emulator] and http://developer.android.com/sdk/index.html[Android Platform Tools].
...
EmulatorPath:: Directory containing the emulator. If not provided, Peach searches the directories in the PATH variable 
for the installed emulator.
