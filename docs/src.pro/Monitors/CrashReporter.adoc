...
The _CrashReporter_ monitor collects and logs core dump information from crashes detected by the OS X System Crash Reporter. Use _CrashReporter_ when crashes can occur and you cannot use  xref:Monitors_Gdb[gdb] or xref:Monitors_CrashWrangler[CrashWrangler].
