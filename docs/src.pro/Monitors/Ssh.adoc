...
To see that Peach is actually checking for the file on the remote machine create a file named target.testing.core in /var/cores. When Peach logs in and finds the file a fault will occur.
