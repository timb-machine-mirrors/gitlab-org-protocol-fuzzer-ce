...
ProcessNames:: 
    Comma separated list of process to kill. Note that the process name is usually the executable
    with out the +.exe+. For example, +notepad.exe+ will be +Notepad+ or +notepad+. For Windows
