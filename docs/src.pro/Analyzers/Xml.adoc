...
image::../src.pro/images/XmlAnalyzerOutputHelloWorld.png["Validator Output", alt="Validator Output"]
...
image::../src.pro/images/XmlAnalyzerOutputEncodingExample.png["Peach Validator Output", alt="Xml Validator Output"]
...
image::../src.pro/images/XmlAnalyzerOutputFromFileExample.png["Peach Validator Output", alt="Xml Validator Output"]
