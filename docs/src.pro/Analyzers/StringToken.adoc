...
.{nbsp}
image::../src.pro/images/StringTokenAnalyzerOutput.png["Validator Output", alt="Validator Output"]
...
.{nbsp}
image::../src.pro/images/StringTokenAnalyzerTokensOutput.png["Validator Output", alt="Validator Output"]
