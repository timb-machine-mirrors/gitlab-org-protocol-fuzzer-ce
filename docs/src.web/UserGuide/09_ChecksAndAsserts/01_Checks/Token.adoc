...
| CWE | https://cwe.mitre.org/data/definitions/285.html[CWE-285: Improper Authorization] https://cwe.mitre.org/data/definitions/331.html[CWE-331: Insufficient Entropy]
...
When used this check performs upto four different validations of the tokens use.
...
The HTTP status code of the response message is then checked to see if the request was successfull.
