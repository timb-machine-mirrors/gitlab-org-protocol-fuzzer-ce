...
Operation::
+
Operations are actions performed on a REST API resource
or service methods for SOAP endpoints.
...
Parameter::
+
Parameters are any piece of data identified when analyzing
the HTTP request.
