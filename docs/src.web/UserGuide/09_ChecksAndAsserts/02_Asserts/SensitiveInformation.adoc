...
This assert performs analysis of API responses and log messagess to detect the following:
...
xref:Check_SensitiveInformation[Sensitive Information Check]
