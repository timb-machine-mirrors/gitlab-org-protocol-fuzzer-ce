...
{
  class DataModelViewModel : ViewModelBase
  {
    public DataModelViewModel(Models.DataModel model, ViewModelBase parent)
      :base(model, parent)
    {
      //this.PeachViewModel = parent;
      this.PeachViewModel.DataModelNodes.Add(model);
      this.PeachViewModel.DataModels.Add(model);
    ...
    protected ObservableCollection<ViewModelBase> WrapItems()
    {
      ...
      Models.DataModel dataModel = (Models.DataModel)this.Model;
    ...
    internal override void ExecuteCreateChild(string parameter)
    {
      ...
      if (dataElementType != null)
      {
        if(dataElementType.IsSubclassOf(typeof(Peach.Core.Dom.DataElementContainer)))
        {
          ...
          ((DataModel)Model).Items.Add(dataElementContainer);
        ...
        else if (dataElementType.IsSubclassOf(typeof(Peach.Core.Dom.DataElement)))
        {
          ...
          ((DataModel)Model).Items.Add(dataElement);
      ...
      if (fixupType != null)
      {
        ...
        ((DataModel)Model).Items.Add(fixup);
      ...
      if (transformerType != null)
      {
        ...
        ((DataModel)Model).Items.Add(transformer);
      ...
      if (m != null)
      {
        ((DataModel)this.Model).Items.Add(m);
    ...
    public override void ReorderItems()
    {
      ...
      ((DataModel)Model).Items = newItems;
    }
    ...
    protected override void DeleteChild(ViewModelBase viewModel)
    {
      ...
      ((DataModel)this.Model).Items.Remove(viewModel.Model);
