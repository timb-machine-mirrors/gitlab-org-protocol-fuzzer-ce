include::TCPv6_DataSheet.txt[]

Configuration
-------------

.Target Configuration
An application must be listening on the TCP port defined in the
configuration file. The network tool socat can be used as the target
application. Using this pit, Peach manages TCP state outside of the
context of the kernel. Because of this it is necessary to also disable
outgoing RST packets. 

_Example of setting up TCPv6:_
[source,bash]
----
