include::IGMP_DataSheet.txt[]

Configuration
-------------

.Target Configuration
A target machine with IGMP enabled.  A firewall must not be blocking IGMP messages.
...
<PitDefines>
  <All>
    ...
    <Define key="TargetIPv4" value="224.0.0.22"/>
    <Define key="LoggerPath" value="logs/IGMP/"/>
