include::avi_divx_DataSheet.txt[]

Configuration
-------------

.Target Configuration
A UDP listener listening on the avi_divx port defined in configuration file is required. The network tool socat can be used.
...
SamplePath:: Direcotry path to the directory which the Avi sample files are stored.
