...
namespace Peach.Pro.Test.Core.Analyzers.WebApi
{
	public class Swagger
	{
		...
		[Peach]
		[Quick]
		public void TestWebApiToDom2()
		{
			var apiEndPoint = SwaggerToWebApi.Convert(json2);
		...
		[Peach]
		[Quick]
		public void TestWebApiToDom3()
		{
			var apiEndPoint = SwaggerToWebApi.Convert(json3);
