include::Gif_DataSheet.txt[]

Configuration
-------------

.Target Configuration
Any number of image viewing programs may be targeted with the GIF file format. Example targets for fuzzing GIF are "feh" on Linux and "mspaint.exe" on Windows. 
