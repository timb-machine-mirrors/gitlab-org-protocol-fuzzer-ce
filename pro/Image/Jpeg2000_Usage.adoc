...
In the JPEG2000.xml.config pit file, you can set the target program that you are fuzzing, such as GIMP 2.8. If available, you can set different target programs for different operating systems.
