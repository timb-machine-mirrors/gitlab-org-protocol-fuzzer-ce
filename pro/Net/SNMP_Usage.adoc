...
.Target Configuration
	A UDP listener listening on the SNMP port defined in configuration file is required. The network tool socat can be used as the listener.

_Example of using socat to listen on SNMP port:_
