...
==========================
Example configuration to send vlan packets

In order to replicate this example, first install vlan and configure vlan. Then, set up socat in different terminals to listen for incoming packets. 

For this example we assume you are running Linux. For other platforms follow the platform specific installation instructions for vlan and socat.
