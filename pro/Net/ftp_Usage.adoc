...
peach -1 --debug FTP_Client.xml Passive
...
#Test client in passive mode
peach FTP_Client.xml Passive

#Test server in active mode
peach FTP_Server.xml

#Test server in passive mode
peach FTP_Server.xml Passive
----
...
<PitDefines>
  <All>
    <Ipv4 key="TargetIPv4" name="Target IP Address" description="" value="10.0.1.23"/>
    <Range key="TargetPort" name="name" description="" min="0" max="65535" value="21"/>
    <String key="LoggerPath" name="Logger Path" description="" value="logs/ftp/"/>
    <Strategy key="Strategy" name="name" description=""  value="Random"/>
    <String key="FtpUser" value="username"/>
    <String key="FtpPass" value="password"/>
    <String key="PitLibraryPath" name="Pit Library Path" description="" value="."/>
    <String key="DataPort" value="31337"/>
  </All>

   <Linux>
     <Iface key="Interface" name="name" description="" value="eth0"/>
     <String key="Program" name="Program" description=""  value="ftp"/>
     <Ipv4 key="SourceIPv4" name="Source IP Address" description="" value="10.0.1.92"/>
   </Linux>

   <OSX>
     <Iface key="Interface" name="name" description="" value="en0"/>
     <String key="Program" name="Program" description="" value="ftp"/>
     <Ipv4 key="SourceIPv4" name="Source IP Address" description="" value="10.0.1.94"/>
   </OSX>

   <Windows>
     <Iface key="Interface" name="name" description="" value="Local Area Connection"/>
     <String key="Program" name="Program" description=""  value="ftp"/>
     <Ipv4 key="SourceIPv4" name="Source IP Address" description="" value="10.0.1.82"/>
   </Windows>
</PitDefines>
----
==========================
