...
<PitDefines>
  <All>
    <String key="LoggerPath" name="Logger Path" description=""  value="./logs/ldap"/>
    ...
    <Range key="TargetPort" name="name" description="" min="0" max="65535" value="389"/>
    <String key="Password" value="password"/>
    <String key="UserName" value="cn=admin,dc=example,dc=com"/>
