...
TargetIPv6:: IP address of the DHCP server (target)
TargetMAC:: MAC address of the DHCP server (target)
SourceIPv6:: IP address of the interface on the local machine (source). Scope/link address is acceptable.
SourceMAC:: MAC address of the local machine (source)
