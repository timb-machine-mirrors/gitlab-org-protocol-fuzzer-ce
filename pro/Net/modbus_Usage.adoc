...
First we must install socat, for this example we assume you are running linux. For other platforms follow the platform specific installation instructions for socat.
