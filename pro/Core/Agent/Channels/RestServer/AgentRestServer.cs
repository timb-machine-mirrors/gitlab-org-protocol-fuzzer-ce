...
{
	[AgentServer("http")]
	public class AgentServerRest : IAgentServer
	{
			...
			using (var evt = new AutoResetEvent(false))
			{
				...
				using (var svc = new RestServer())
				{
					...
					finally
					{
						...
						svc.Context.Agent.AgentDisconnect();
	...
	internal class Bootstrapper : DefaultNancyBootstrapper
	{
		...
		static Bootstrapper()
		{
			...
			ResourceViewLocationProvider.RootNamespaces.Add(
				...
				"Peach.Core.Agent.Channels.RestServer");
		}

		public Bootstrapper(RestContext context)
		{
		...
		protected override void ConfigureApplicationContainer(TinyIoCContainer container)
		{
			...
			// WebContext
			container.Register<RestContext>(context);
	...
	internal class ErrorResponse : Nancy.Responses.JsonResponse
	{
		private class Error
		{
	...
	public class RestServer : IDisposable
	{
		...
		public RestContext Context { get; private set; }
