...
First we must install VLC player, for this example we assume you are running on Ubuntu or Debian. For other platforms follow instructions on the VLC http://www.videolan.org/vlc/index.html[website]:
