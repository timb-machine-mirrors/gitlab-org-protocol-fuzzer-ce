...
First we must install VLC player, for this example we assume you are running on ubuntu or debian. For other platforms follow instructions per VLC http://www.videolan.org/vlc/index.html[website]:
