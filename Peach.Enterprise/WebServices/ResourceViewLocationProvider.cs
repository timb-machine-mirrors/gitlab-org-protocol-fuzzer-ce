// Taken from https://github.com/NancyFx/Nancy/commit/2785070821edf39cb46c5949c07cd0075ae186f8
// to fix the bug not included in nancy 0.22
...
namespace Peach.Enterprise.WebServices
{
    ...
    public class ResourceViewLocationProvider : IViewLocationProvider
    {
        ...
        /// </summary>
        /// <param name="supportedViewExtensions">An <see cref="T:IEnumerable`1"/> instance, containing the view engine file extensions that is supported by the running instance of Nancy.</param>
        /// <returns>An <see cref="T:IEnumerable`1"/> instance, containing <see cref="ViewLocationResult"/> instances for the located views.</returns>
